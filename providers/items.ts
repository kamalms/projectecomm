...
export class Items {
  ...
  },
  {
    ...
    "description": "An 8-ounce serving of our refresing H+ Sport blueberry mineral water fulfills a day's nutritional requirements for over 12 vitamins and minerals.",
    "price": "2.80",
  ...
  },
  {
    ...
    "description": "An 8-ounce serving of our refresing H+ Sport lemon-lime mineral water fulfills a day's nutritional requirements for over 12 vitamins and minerals",
    "price": "2.80",
  ...
  },
  {
    ...
    "price": "22",
    "image": "https://hplussport.com/wp-content/uploads/2016/12/crossback-tank_LYNDA_29936.jpg",
    "gender": "unisex"
  }
];
    let items = [
